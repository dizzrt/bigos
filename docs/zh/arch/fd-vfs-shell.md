...
- Source-level checks 覆盖 VFS root 发布、cwd resolution、open 拒绝、fd 容量、bad fd 与 double-close、EOF clamp、offset advancement、metadata snapshot、exec close-on-exec，以及 safe reaper close-all。
