...
| `journal-recovery` | `--journal_recovery_smoke=y` | `BIGOS_JOURNAL_RECOVERY_PASSED` | 40s | M15.2 mount-time journal recovery 验证，覆盖 clean mount、committed replay、重复 replay 幂等、partial discard、corrupt reject 与 recovery I/O failure fail-closed 行为。 |
