...
| `userland-runtime` | `--userland_smoke=y` | `BIGOS_USERLAND_PASSED` | 40s | crt0/libc wrapper、参数/环境传递、stdout/stderr、errno、简单 C 程序基线探针、shell 执行、fork/exec/wait、pipe、重定向、malloc 和有界 `/rw` 运行时文件操作。 |
