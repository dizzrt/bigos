...
- 可能修改文件：`include/arch/x86/boot/boot_info.h`、`kernel/arch/x86/boot/boot.s`、`kernel/runtime/crt0.s`、`kernel/core/kernel.cc`、`kernel/mm/buddy.cc`、`include/bigos/memory.h` 或相关 mm header、`docs/en/arch/x86-boot-layout.md`、`docs/en/arch/uefi-boot-blueprint.md`。
