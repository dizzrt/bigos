...
- `clang++ -std=c++17 -target x86_64-unknown-none -ffreestanding -fno-rtti -fno-exceptions -mno-red-zone -mno-sse -mno-sse2 -mno-mmx -Iinclude -Icpp/include -Icpp/libsupc++/include -fsyntax-only src/kernel/proc/proc.cc src/kernel/syscall/syscall.cc src/kernel/irq/interrupt.cc src/mm/vmem.cc`: passed.
- clangd diagnostics through the IDE diagnostics API: passed for `include/bigos/proc.h`, `include/bigos/syscall.h`, `src/kernel/proc/proc.cc`, `src/kernel/syscall/syscall.cc`, `src/kernel/irq/interrupt.cc`, `src/mm/vmem.h`, and `src/mm/vmem.cc`.
