...
- 受影响代码：[interrupt.cc](file:///Users/bytedance/Desktop/workspace/kernel/bigos/src/kernel/irq/interrupt.cc#L42-L61) 的 `page_fault_handler`、[proc.cc](file:///Users/bytedance/Desktop/workspace/kernel/bigos/src/kernel/proc/proc.cc#L1280-L1368) 的 `map_anonymous_current` / `brk_current` / `try_handle_current_stack_fault`、[proc.h](file:///Users/bytedance/Desktop/workspace/kernel/bigos/include/bigos/proc.h) 的相关声明。
