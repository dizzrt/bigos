...
Define the bounded x86_64 APIC-backed default interrupt delivery model for BigOS, including supported external IRQ routing, EOI ownership, timer and keyboard migration, ABI review, fallback boundaries, and validation expectations without claiming CPU hotplug, NUMA, MSI/MSI-X, complete IRQ affinity, or non-x86_64 backend parity.
