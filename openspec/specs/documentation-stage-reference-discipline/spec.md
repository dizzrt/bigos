...
Define the documentation discipline that keeps BigOS current documentation,
OpenSpec changes, and archived records focused on capabilities, behavior names,
implementation boundaries, and validation semantics instead of historical
roadmap stage or roadmap task numbering.
