# journal-mount-recovery Specification

## Purpose

Define persistent `/rw` mount-time journal recovery for journal-capable bigfs volumes. This capability covers bounded recovery before VFS publication, committed transaction replay, safe discard of provably uncommitted partial transactions, fail-closed handling for corrupt or unsupported journal states, and default-off recovery validation.
