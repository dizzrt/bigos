# pci-msix-interrupt-delivery Specification

## Purpose
定义 BigOS 内核内部的 PCI MSI-X capability 解析、table/PBA 映射、条目编程、向量分配整合与 LAPIC EOI 投递边界，为后续 modern PCI 设备驱动提供有界的 MSI-X 中断投递基础设施。
